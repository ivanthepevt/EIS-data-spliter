#This is a patchy version of spliter to handle the case when the starting frequency is duplicated, the idea is to indicate a round when the starting frequency is caught 2 times.
    ...
    for row in ws.values:
        ...
        if row[0] == F0:
            ...
            if timer%2 == 0:
                ...
                ws_new = wb_new.create_sheet(ws.title + " " + str('{:g}'.format(timer/2 - 1)))
